...
/**
 * Abstract base class for defining License options.
 */
@EModel(namespace = "ap", description = "License Options", name = "AbstractLicenseOptions", version = ApVersion.PROJECT_VERSION)
...
public class AbstractLicenseOptions implements Serializable {

    private static final long serialVersionUID = 1L;

    @PrimaryTypeAttribute
    @EModelAttribute(description = "The ID of the LicenseOptions MO", key = true, immutable = true, mandatory = true)
    @NotNull
    public String licenseOptionsId;
}
