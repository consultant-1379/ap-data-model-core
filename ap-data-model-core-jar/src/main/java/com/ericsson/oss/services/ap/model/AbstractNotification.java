...
/**
 * Abstract class containing common node notification information.
 */
@EModel(namespace = "ap", description = "Auto Provisioning Node Notifications", name = "AbstractNotification", version = ApVersion.PROJECT_VERSION)
...
public class AbstractNotification implements Serializable {
    ...
    @EModelAttribute(description = "The ID of the Notification MO", key = true, immutable = true, mandatory = true)
    @NotNull
