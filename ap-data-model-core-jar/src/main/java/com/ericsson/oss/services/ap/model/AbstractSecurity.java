...
/**
 * Abstract class containing common node security information.
 */
@EModel(namespace = "ap", description = "Auto Provisioning Node Security", name = "AbstractSecurity", version = ApVersion.PROJECT_VERSION)
...
public class AbstractSecurity implements Serializable {

    private static final long serialVersionUID = 1L;

    @PrimaryTypeAttribute
    @EModelAttribute(description = "The ID of the Security MO", key = true, immutable = true, mandatory = true)
    @NotNull
