...
/**
 * Abstract base class for defining Auto Provisioning options.
 */
@EModel(namespace = "ap", description = "Auto Integration Options", name = "AbstractAutoIntegrationOptions", version = ApVersion.PROJECT_VERSION)
...
public class AbstractAutoIntegrationOptions implements Serializable {

    private static final long serialVersionUID = 1L;

    @PrimaryTypeAttribute
    @EModelAttribute(description = "The ID of the AutoIntegrationOptions MO", key = true, immutable = true, mandatory = true)
    @NotNull
    public String AutoIntegrationOptionsId;
}
